...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:dn,depthTest:!1,depthWrite:!1})}function Ca(){return new Dn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:gs(),fragmentShader:`
		...
		`,blending:dn,depthTest:!1,depthWrite:!1})}function Pa(){return new Dn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:gs(),fragmentShader:`
