...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:fn,depthTest:!1,depthWrite:!1})}function La(){return new Un({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:gs(),fragmentShader:`
		...
		`,blending:fn,depthTest:!1,depthWrite:!1})}function Da(){return new Un({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:gs(),fragmentShader:`
